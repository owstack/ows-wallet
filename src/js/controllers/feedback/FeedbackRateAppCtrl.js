...
angular.module('owsWalletApp.controllers').controller('FeedbackRateAppCtrl', function($scope, $state, $stateParams, $window, lodash, externalLinkService, platformInfoService, feedbackService, ongoingProcessService, configService, appConfigService) {
