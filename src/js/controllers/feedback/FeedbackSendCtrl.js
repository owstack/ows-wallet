...
angular.module('owsWalletApp.controllers').controller('FeedbackSendCtrl', function($scope, $state, $log, $timeout, $stateParams, $ionicNavBarDelegate, $ionicHistory, $ionicConfig, $window, gettextCatalog, popupService, configService, lodash, feedbackService, ongoingProcessService, platformInfoService, appConfigService) {
