...
angular.module('owsWalletApp.controllers').controller('AddressBookEntryEditCtrl', function($rootScope, $scope, $state, $log, $timeout, $ionicModal, $ionicHistory, lodash, addressBookService, popupService, gettextCatalog, networkService) {
