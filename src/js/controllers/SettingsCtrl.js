...
angular.module('owsWalletApp.controllers').controller('SettingsCtrl', function($timeout, $scope, appConfigService, uxLanguageService, platformInfoService, profileService, configService, gettextCatalog, networkService, addressBookService) {
