...
angular.module('owsWalletApp.controllers').controller('OnboardingDisclaimerCtrl', function($scope, $state, $log, $ionicConfig, $ionicNativeTransitions, profileService, uxLanguageService, $stateParams, startupService) {
