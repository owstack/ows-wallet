...
angular.module('owsWalletApp.controllers').controller('OnboardingBackupRequestCtrl', function($scope, $state, $stateParams, $ionicConfig, popupService, gettextCatalog) {
