...
angular.module('owsWalletApp.controllers').controller('OnboardingBackupWarningCtrl', function($scope, $ionicNativeTransitions, $timeout, $stateParams, $ionicModal) {
  ...
  $scope.openPopup = function() {
    $ionicModal.fromTemplateUrl('views/includes/screenshot-warning-modal.html', {
      scope: $scope,
