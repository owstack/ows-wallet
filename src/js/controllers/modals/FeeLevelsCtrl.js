...
angular.module('owsWalletApp.controllers').controller('FeeLevelsCtrl', function($scope, $timeout, $log, lodash, gettextCatalog, feeService, ongoingProcessService, popupService, networkService) {
