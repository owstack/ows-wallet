...
angular.module('owsWalletApp.controllers').controller('PreferencesExternalHardwareCtrl', function($scope, $stateParams, lodash, gettextCatalog, popupService, profileService, walletService) {
