...
angular.module('owsWalletApp.controllers').controller('PreferencesInformationCtrl',
  function($scope, $log, $ionicHistory, platformInfoService, lodash, profileService, $stateParams, $state, walletService, networkService) {
