...
angular.module('owsWalletApp.controllers').controller('PreferencesFeeCtrl', function($scope, $timeout, $ionicHistory, lodash, gettextCatalog, configService, feeService, ongoingProcessService, popupService, networkService, helpService) {
