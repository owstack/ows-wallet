...
angular.module('owsWalletApp.controllers').controller('PreferencesColorCtrl', function($scope, $timeout, $log, $stateParams, $ionicHistory, profileService, uiService, walletService) {
