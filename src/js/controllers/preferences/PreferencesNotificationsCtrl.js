...
angular.module('owsWalletApp.controllers').controller('PreferencesNotificationsCtrl', function($scope, $log, $timeout, appConfigService, lodash, configService, platformInfoService, pushNotificationsService, emailService) {
