...
angular.module('owsWalletApp.controllers').controller('PreferencesUnitCtrl', function($scope, $log, lodash, configService, $ionicHistory, gettextCatalog, walletService, profileService, networkService) {
