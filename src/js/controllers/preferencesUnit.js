...
angular.module('owsWalletApp.controllers').controller('preferencesUnitController', function($scope, $log, lodash, configService, $ionicHistory, gettextCatalog, walletService, profileService, networkService) {
