'use strict';
angular.module('owsWalletApp.services').factory('amazonService', function($http, $log, lodash, moment, storageService, configService, platformInfo, nextStepsService, homeIntegrationsService, networkService) {
  var root = {};
  var credentials = {};
