...
angular.module('owsWalletApp.directives').directive('slideToAccept', function($timeout, $window, $q) {
  return {
    restrict: 'E',
    templateUrl: 'shared/directives/slide-to-accept/slide-to-accept.html',
    transclude: true,
    scope: {
      sendStatus: '=status',
      onConfirm: '&onConfirm',
