...
angular.module('owsWalletApp.directives').directive('incomingDataMenu', function($timeout, $rootScope, $state, externalLinkService) {
  return {
    restrict: 'E',
    ...
    link: function(scope, element, attrs) {
      ...
      scope.sendPaymentToAddress = function(networkName, address) {
        scope.showMenu = false;
      ...
      scope.addToAddressBook = function(networkName, address) {
        scope.showMenu = false;
        $timeout(function() {
