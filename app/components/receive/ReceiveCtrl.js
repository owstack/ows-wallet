...
angular.module('owsWalletApp.controllers').controller('ReceiveCtrl', function($rootScope, $scope, $timeout, $log, $state, $ionicHistory, platformInfoService, walletService, profileService, lodash, gettextCatalog, popupService, networkService) {
