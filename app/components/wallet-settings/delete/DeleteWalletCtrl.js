...
angular.module('owsWalletApp.controllers').controller('DeleteWalletCtrl', function($rootScope, $scope, $ionicHistory, gettextCatalog, profileService, $state, ongoingProcessService, popupService, pushNotificationsService) {
