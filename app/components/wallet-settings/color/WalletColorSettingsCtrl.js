...
angular.module('owsWalletApp.controllers').controller('WalletColorSettingsCtrl', function($scope, $timeout, $log, $stateParams, $ionicHistory, profileService, uiService, walletService) {
