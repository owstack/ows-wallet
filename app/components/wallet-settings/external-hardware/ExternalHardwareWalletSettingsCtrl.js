...
angular.module('owsWalletApp.controllers').controller('ExternalHardwareWalletSettingsCtrl', function($scope, $stateParams, lodash, gettextCatalog, popupService, profileService, walletService) {
  ...
  if ($scope.externalSource.isEmbeddedHardware) {
    ...
    $scope.showMneumonicFromHardwarePopup = function() {
      ...
      var message = gettextCatalog.getString('Are you being watched? Anyone with your recovery phrase can access or spend your money.');
