...
angular.module('owsWalletApp.controllers').controller('TxSearchCtrl', function($scope, $timeout, $log, $ionicScrollDelegate, lodash, gettext, gettextCatalog, platformInfoService, uxLanguageService, addressBookService) {
