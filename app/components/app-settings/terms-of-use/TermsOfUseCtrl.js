...
angular.module('owsWalletApp.controllers').controller('TermsOfUseCtrl', function($scope, appConfig, uxLanguageService, externalLinkService, gettextCatalog) {
  $scope.lang = uxLanguageService.currentLanguage;

  $scope.openExternalLink = function() {
    var url = appConfig.disclaimerUrl;
    var optIn = true;
