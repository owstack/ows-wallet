'use strict';
angular.module('owsWalletApp.services').factory('errorService', function($log, gettextCatalog) {
  var root = {};
    ...
    if (name) {
      switch (name) {
        ...
        case 'TX_NOT_PENDING':
          ...
          break;
        case 'UPGRADE_NEEDED':
          body = gettextCatalog.getString('Please upgrade to perform this action.');
          break;
        case 'BAD_SIGNATURES':
