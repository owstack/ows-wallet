...
angular.module('owsWalletApp.pluginApi').factory('ApiRouter', function (lodash, pathToRegexpService) {
  ...
  var routeMap = [
    ...
    { path: '/applet/show',                           method: 'PUT',    handler: 'showApplet' },
    { path: '/applet/splash',                         method: 'DELETE', handler: 'hideSplash' },
    { path: '/plugin/preferences',                    method: 'POST',   handler: 'setPluginPreferences' },
    { path: '/session/:id',                           method: 'DELETE', handler: 'closeSession' },
    { path: '/session/:id',                           method: 'GET',    handler: 'getSession' },
    { path: '/session/:id/wallets',                   method: 'GET',    handler: 'getWallets' },
    { path: '/session/:id/scanqr',                    method: 'GET',    handler: 'getQrScanData' },
    ...
    { path: '/wallet/:id/address',                    method: 'GET',    handler: 'getWalletAddress' },
    { path: '/wallet/:id/transactions/:txid?',        method: 'GET',    handler: 'getWalletTransactions' },
