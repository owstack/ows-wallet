...
If you are having particular problem with your wallet installation, please first [search older 
issues](https://github.com/owstack/ows-wallet/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/owstack/ows-wallet/wiki/FAQ).
...
provide the following information:
 ...
 - Please check wallet logs (General Settings -> About -> Session Logs). Look for 
...
Please adhere to the coding conventions used throughout (indentation, tests, etc.)
